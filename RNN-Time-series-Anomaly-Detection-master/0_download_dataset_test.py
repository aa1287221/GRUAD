    ...
    for filepath in raw_dir.glob('*.txt'):
        with open(str(filepath)) as f:
            ...
            for i, line in enumerate(f):
                ...
                #     tokens.append(
                #         1.0) if 2250 < i < 2400 else tokens.append(0.0)
                # elif filepath.name == 'xmitdb_x108_0.txt':
                #     tokens.append(
                #         1.0) if 4020 < i < 4400 else tokens.append(0.0)
                # elif filepath.name == 'mitdb__100_180.txt':
                #     tokens.append(
                #         1.0) if 1800 < i < 1990 else tokens.append(0.0)
                # elif filepath.name == 'chfdb_chf01_275.txt':
                #     tokens.append(
                #         1.0) if 2330 < i < 2600 else tokens.append(0.0)
                ...
                #     tokens.append(
                #         1.0) if 4230 < i < 4430 else tokens.append(0.0)
                # elif filepath.name == 'ann_gun_CentroidA.txt':
                #     tokens.append(
                #         1.0) if 2070 < i < 2810 else tokens.append(0.0)
                # elif filepath.name == 'TEK16.txt':
                #     tokens.append(
                #         1.0) if 4270 < i < 4370 else tokens.append(0.0)
                # elif filepath.name == 'TEK17.txt':
                #     tokens.append(
                #         1.0) if 2100 < i < 2145 else tokens.append(0.0)
                # elif filepath.name == 'TEK14.txt':
                #     tokens.append(
                #         1.0) if 1100 < i < 1200 or 1455 < i < 1955 else tokens.append(0.0)
                # elif filepath.name == 'nprs44.txt':
                #     tokens.append(
                #         1.0) if 16192 < i < 16638 or 20457 < i < 20911 else tokens.append(0.0)
                # elif filepath.name == 'nprs43.txt':
                #     tokens.append(
                #         1.0) if 12929 < i < 13432 or 14877 < i < 15086 or 15729 < i < 15924 else tokens.append(0.0)
                ...
                if filepath.name == 'NoiseSymbol.txt':
                    tokens.append(
                        1.0) if 334 < i < 336 or 401 < i < 407 or 604 < i < 610 or 1651 < i < 1653 else tokens.append(0.0)
            ...
            if filepath.name == 'ann_gun_CentroidA.txt':
                for i, datapoint in enumerate(labeled_data):
                    for j, channel in enumerate(datapoint[:-1]):
                        if channel == 0.0:
                            labeled_data[i][j] = 0.5 * labeled_data[i
                                                                    - 1][j] + 0.5 * labeled_data[i + 1][j]
...
#     'labeled', 'trainex', nyc_taxi_raw_path.name).with_suffix('.pkl')
...
#
# nyc_taxi_test_path = nyc_taxi_raw_path.parent.parent.joinpath(
#     'labeled', 'test', nyc_taxi_raw_path.name).with_suffix('.pkl')
